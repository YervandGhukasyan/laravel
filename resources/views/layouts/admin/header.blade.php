            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#" class=" hvr-bounce-to-right"><i class="fa fa-indent nav_icon"></i> <span class="nav-label">Product Types</span><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li><a href="graphs.html" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>All Product Types</a></li>

                                <li><a href="{{url('admin/prType/create')}}" class=" hvr-bounce-to-right"><i class="fa fa-map-marker nav_icon"></i>Create</a></li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li><a href="graphs.html" class=" hvr-bounce-to-right"> <i class="fa fa-area-chart nav_icon"></i>All Product</a></li>

                                <li><a href="{{url('admin/product/create')}}" class=" hvr-bounce-to-right"><i class="fa fa-map-marker nav_icon"></i>Create</a></li>
